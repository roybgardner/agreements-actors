...
The anomaly is caused by duplicate row in inks\_table.csv. For example, rows with \texttt{signatory\_id} values \texttt{1290} and \texttt{1292} are identical in all other fields.\newline

The analysis software does not support duplicate agreement-actor pairs.
