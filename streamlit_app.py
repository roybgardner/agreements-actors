...
plt.xticks(fontsize='xx-large')    
plt.yticks(fontsize='xx-large')    
plt.ylabel('Actor indices',fontsize='xx-large')
plt.xlabel('Actor indices',fontsize='xx-large')
...
plt.xticks(fontsize='xx-large')    
plt.yticks(fontsize='xx-large')    
plt.ylabel('Agreement indices',fontsize='xx-large')
plt.xlabel('Agreement indices',fontsize='xx-large')
plt.title('Agreements co-occurrence matrix')
plt.colorbar()
st.pyplot(f)
